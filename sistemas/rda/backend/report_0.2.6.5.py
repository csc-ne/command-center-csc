...
# VERSÃO ESTÁVEL - 0.2.6.5 - Data 12/05/2026 - Versão Estável 
# =======================================================================
...
def rda_py_gerar(cliente_id: int, data_inicial: str, data_final: str, datas_relatorio=None, progress_callback=None):

    # Callback de progresso — se fornecido, é chamado com (percentual, descricao)
    ...
    _progress(0, "Iniciando geração do relatório...")
    ...
    _progress(5, "Consultando dados do cliente...")
    ...
    cliente_analises_quimicas = kernel_consulta.analises_quimicas(id_client=cliente_id, 
                                                                            data_inicial=data_inicial, 
                                                                            data_final=data_final)
    ...
    _progress(20, "Consultas ao banco concluídas. Processando tabelas...")
    ...
    _progress(35, "Métricas de utilização concluídas. Processando alertas...")
    ...
    #======================================================================#
    _progress(50, "Alertas e análises concluídas. Gerando gráficos...")
   ...
   # ------------------------------------------------------------------------
    _progress(65, "Gráficos gerados. Montando PDFs auxiliares...")
    ...
    # ------------------------------------------------------------------------
    _progress(75, "Gerando seções do relatório PDF...")
    ...
    _progress(80, "Renderizando páginas do relatório...")
    ...
    _progress(92, "Compilando PDF final...")
    func_compilar_pdfs(arquivo_principal, arquivos_compilado)

    _progress(97, "Limpando artefatos temporários...")
    ...
    _progress(100, "Relatório concluído!")
...
def rda_py_data_movel(cliente_id: int, data_inicial: str, data_final: str, progress_callback=None):
...
if __name__ == "__main__":
    ...
    print(YELLOW + r"""
                        ...
                        ██╔══██╗██║  ██║██╔══██║
                        ██║  ██║██████╔╝██║  ██║
        |RDA - RELATÓRIOS DE DESEMPENHO AUTOMÁTICOS - Versão 0.2.6.5 - 05/2026 - Versão Estável
    ...
    while True:
        ...
        try:
            ...
            print("Valor inválido. Informe apenas 1, 2, 3 ou 4.")
            continue
